...
export const AI_PROMPTS_DATA: AIPrompt[] = [
  // --- 1. البرمجة وتتبع الأخطاء (Coding) ---
  {
    ...
    recommendedModel: 'DeepSeek-R1 / Claude 3.7 Sonnet / Gemini 3.7 Flash',
...
4. إعطاء نصيحة لمنع وقوع نفس الخطأ مستقبلاً.`
  },
  {
    ...
    category: 'coding',
    categoryLabel: 'البرمجة وتتبع الأخطاء',
    recommendedModel: 'Qwen 2.5 Coder / Claude 3.7 Sonnet / Gemini 3.7 Flash',
...
3. تنظيم حالات الاختبار بوصف صريح وواضح باللغة الإنجليزية أو العربية.`
  ...
  },
  {
    ...
    category: 'gameDev',
    categoryLabel: 'تطوير الألعاب والـ Pixel Art',
    recommendedModel: 'Claude 3.7 Sonnet / DeepSeek-R1 / Gemini 3.7 Flash',
...
3. كتابة تعليقات توضيحية أمام كل دالة.`
  },
  {
    ...
    category: 'gameDev',
    categoryLabel: 'تطوير الألعاب والـ Pixel Art',
    recommendedModel: 'Claude 3.7 Sonnet / Gemini 3.7 Flash / OpenAI GPT-5',
...
4. **أهم 3 نتائج وتوصيات (Key Takeaways)**.`
  ...
  // --- 4. التلخيص ونسخ النصوص (Summarization) ---
  {
    ...
    recommendedModel: 'Gemini 3.7 Flash / Claude 3.7 Sonnet',
...
3. تقديم كود DDL جاهز للتشغيل مباشرة باللغة المناسبة.`
  ...
  // --- 7. البرومبتات الإضافية المتقدمة (Advanced Developer Prompts) ---
  {
    ...
    category: 'gameDev',
    categoryLabel: 'تطوير الألعاب والـ Pixel Art',
    recommendedModel: 'Claude 3.7 Sonnet / Gemini 3.7 Flash / DeepSeek-R1',
...
4. شرح الفرق العملياتي إن وُجد.`
  },
  {
    ...
    category: 'coding',
    categoryLabel: 'البرمجة وتتبع الأخطاء',
    recommendedModel: 'Gemini 3.7 Flash / DeepSeek-R1 / GPT-5',
